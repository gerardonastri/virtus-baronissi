            ...
            <div className={styles.content}>
                ...
                <form className={styles.form} ref={form} onSubmit={handleSubmit}>
                    ...
                    <div className={styles.formFlex}>
                        <input type="text" name="user_name" id="name" placeholder='Nome' value={nome} onChange={(e) => setNome(e.target.value)} />
                        <input type="text" name="phone" id="phone" placeholder='Telefono'  value={telefono} onChange={(e) => setTelefono(e.target.value)} />
                    </div>
                    <input type="email" name="user_email" id="email" placeholder='Email'  value={email} onChange={(e) => setEmail(e.target.value)} />
